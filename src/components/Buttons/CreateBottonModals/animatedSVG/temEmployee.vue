<template>
  ...
  >
    ...
    <g class="tank">
      ...
      <path
        opacity="0.1"
        d="M150,58.7c-2.9,0-5.7,0.9-8.3,2.5c1-0.2,1.9-0.3,2.9-0.3c11.8,0,21.4,14.8,21.4,26.6v107.5h5.3V85.2
    ...
    <g id="thruster">
      <g class="thruster-2">
        <g>
          <path
            fill="#FFFFFF"
            d="M181,212.8v-74c0-3.3,2.7-8.4,5-8.4s5,5.1,5,8.4v74H181z"
          />
          <g>
            <path
              fill="#333333"
              d="M186,131.9c1,0,3.5,3.8,3.5,6.9v72.5h-7.1v-72.5C182.5,135.7,185.1,131.9,186,131.9 M186,128.9
        ...
        <polygon
          ...
          fill="#333333"
          points="179.5,214.2 179.5,214.3 192.6,214.3 192.6,166.2 179.5,141.4 		"
        />
      ...
      <g class="thruster-1">
        <g>
          <path
            fill="#FFFFFF"
            d="M108.8,212.8v-74c0-3.3,2.7-8.4,5-8.4s5,5.1,5,8.4v74H108.8z"
          />
          <path
            fill="#333333"
            d="M113.9,131.9c1,0,3.5,3.8,3.5,6.9v72.5h-7.1v-72.5C110.3,135.7,112.9,131.9,113.9,131.9 M113.9,128.9
    ...
    <g id="rocket-body">
      <g>
        <path
          fill="#F4F4F4"
          d="M102.1,214.1c-0.2,0-0.4,0-0.6-0.1c-1.6-0.7-2.4-2.9-2.8-4.2c-1-3.5-1-8.7,1.9-13.1c1-1.5,3-2.8,5.7-4.6
        ...
        <path
          fill="#333333"
          d="M137.4,150.2c0,15.4,0,62.4,0,62.4s-31.6,0-35.3,0c-2.1-1-4.3-9.1-0.3-15.1
      ...
      <g>
        <path
          fill="#CCCCCC"
          d="M162.6,214.1c-0.8,0-1.5-0.7-1.5-1.5v-62.4c0-0.8,0.6-1.4,1.3-1.5c0.1,0,0.1,0,0.2,0
        ...
        <g>
          <path
            fill="#333333"
            d="M162.6,150.2c9.4,36.1,32.2,42.1,35.6,47.3c4,6,1.9,14.1-0.3,15.1c-3.7,0-35.3,0-35.3,0
      ...
      <g>
        <path
          fill="#FFFFFF"
          d="M143.7,229.4c-0.7,0-1.2-0.4-1.4-1.1c-2.9-9.5-6.4-23-6.4-33.7v-75.7c0-4.7,7.4-22.6,14.1-22.6
			c6.8,0,14.1,18,14.1,22.6v75.7c0,10.7-3.5,24.3-6.4,33.7c-0.2,0.6-0.8,1.1-1.4,1.1H143.7z"
        />
        <path
          fill="#333333"
          d="M150,97.8c5.5,0,12.6,16.7,12.6,21.1c0,4.4,0,59,0,75.7c0,10.8-3.7,24.8-6.3,33.3h-12.5
      ...
      <g>
        <path
          fill="#EBEBEB"
          d="M150,97.8c-1,0-2,0.5-3,1.4c5.3,1.3,11.9,16.8,11.9,21c0,4.4,0,59,0,75.7c0,10.3-3.4,23.4-5.9,32h3.4
      ...
      <path
        fill="#EBEBEB"
        d="M150,198.1v29.8h6.3c0.9-2.9,1.9-6.5,2.9-10.4l-7.7-19.4H150z"
      />
      <line
        fill="#FFFFFF"
        stroke="#333333"
